...
namespace FractalMachine.Ambiance.gOld
{
    abstract public class Repository
    {
        ...
        public virtual InstallationResult Install(string Package, bool Dependency = false)
        {
            ...
            // For cygwin, look for mingw version of the package
            solvePackageName(Package);
        ...
        internal virtual void solvePackageName(string name)
        {
        }
        ...
        public class Cygwin : Repository
        {
            ...
            internal override void solvePackageName(string name)
            {
                string prefix = "mingw64-x86_64-";
                Package res;
                if (packages.TryGetValue(prefix + name, out res))
                {
                    Install(prefix + name, true);
                }
            }
